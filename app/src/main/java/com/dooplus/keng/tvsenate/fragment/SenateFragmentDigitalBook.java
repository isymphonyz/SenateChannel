...
public class SenateFragmentDigitalBook extends Fragment {

    private ProgressBar progressBar;
    private WebView webView;
    private String url = MyConfiguration.URL_DIGITALBOOK;
    private Typeface tf;

    private AppPreference appPreference;
    private String language = "";

    public static SenateFragmentDigitalBook newInstance() {
        SenateFragmentDigitalBook fragment = new SenateFragmentDigitalBook();
        return fragment;
    }
    ...
    private void initValue() {
        url = AppPreference.getInstance(getActivity()).getURDigitalLBook();
    }
