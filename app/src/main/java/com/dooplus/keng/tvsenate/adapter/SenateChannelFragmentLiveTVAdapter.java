 ...
 */
public class SenateChannelFragmentLiveTVAdapter extends BaseAdapter {
    ...
    public SenateChannelFragmentLiveTVAdapter(Activity a) {
        activity = a;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vi = inflater.inflate(R.layout.fragment_live_tv_list_item, null);
